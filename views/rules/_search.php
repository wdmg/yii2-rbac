...
<div class="panel panel-default">
    <div class="panel-heading">
        <h5 class="panel-title">
            <a data-toggle="collapse" href="#ruleSearch">
                <span class="glyphicon glyphicon-search"></span> <?= Yii::t('app/modules/rbac', 'Search rule') ?>
            </a>
        </h5>
    </div>
    <div id="ruleSearch" class="panel-collapse collapse">
